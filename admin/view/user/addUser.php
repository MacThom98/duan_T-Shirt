...
<form action="<?php $ADMIN_URL.'/view/user?action=btn_add'?>" method="POST">
  ...
  <button type="submit" name="btn_add" class="btn btn-primary">Thêm khách hàng</button> 
...
<a href="<?=$ADMIN_URL.'/view/user'?>" class="btn btn-primary">Danh sách khách hàng</a>
  </div>
